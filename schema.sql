...
insert into conventions (name) values ("ביגור 16");
insert into api_keys (convention_id, client_key, client_secret) values (1, "M2UyZjJlNzE2M2RkYmVkZWZiYjkzZDRiZGJmOGVlNzM1YjBlN2ZkNQ", "123456");
